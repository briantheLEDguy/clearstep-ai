...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/clearstep" },
};
      ...
      <section className="hero shell">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <Link className="button button-primary" href="/clearstep/workshops">Find a workshop</Link>
            <Link className="text-link" href="/clearstep/private-workshops">Plan a private session <span aria-hidden="true">→</span></Link>
          </div>
      ...
      <section className="workshop-preview">
        <div className="shell">
          <div className="section-heading">
            ...
            <Link className="text-link" href="/clearstep/workshops">See all workshops <span aria-hidden="true">→</span></Link>
          </div>
          {catalog.status === "ready" ? (
            ...
            <div className="empty-state rounded-[24px] border border-[var(--border)] bg-white p-7 md:p-8" role="status">
              ...
              <Link className="text-link mt-5 inline-block" href="/clearstep/private-workshops">Plan a private session <span aria-hidden="true">→</span></Link>
            </div>
          )}
        </div>
      </section>
